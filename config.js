...
module.exports = {
    ...
    OWNERNUM: process.env.OWNER_NUMBER === undefined ? '6281383717473' : process.env.OWNER_NUMBER,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://imgur.com/kB30S41.png' : process.env.ALIVE_LOGO,
    TERRORBOY: process.env.TAG_REPLY === undefined ? '6281383717473@s.whatsapp.net' : process.env.TAG_REPLY,
    LIYANAME: process.env.LIYA_NAME === undefined ? 'ZARA MWOL' : process.env.LIYA_NAME,
    SAIDNUMBER: process.env.SAID_NUMBER=== undefined ? '62895383201495' : process.env.SAID_NUMBER,
